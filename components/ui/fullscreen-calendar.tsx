  ...
  return (
    <div className="flex flex-1 flex-col h-full">
        ...
        <div className="flex flex-col items-center gap-4 md:flex-row md:gap-6">
          ...
          {onNewTask && (
            <>
              ...
              <Button onClick={onNewTask} className="w-full gap-2 md:w-auto">
      ...
      <div className="lg:flex lg:flex-auto lg:flex-col overflow-hidden">
        ...
        {/* Calendar Days */}
        <div className="flex text-xs leading-6 lg:flex-auto overflow-auto">
          <div className="hidden w-full border-x lg:grid lg:grid-cols-7 lg:grid-rows-5 lg:auto-rows-fr">
            {days.map((day, dayIdx) =>
              !isDesktop ? (
                <button
                        ...
                        <div key={day.day.toString()} className="space-y-1.5">
                          {day.tasks.slice(0, 2).map((task) => (
                            <div
                              ...
                              className={cn(
                                "flex flex-col items-start gap-1 rounded-lg border p-2 text-xs leading-tight cursor-pointer transition-colors",
                                task.completed
